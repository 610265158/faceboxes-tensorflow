...
class RDCLSeparable(tf.keras.Model):

    def __init__(self,
                 kernel_initializer='glorot_normal'):

        super(RDCLSeparable, self).__init__()

        self.conv1_1 = tf.keras.layers.SeparableConv2D(filters=12,
                                              kernel_size=(7, 7),
                                              strides=2,
                                              padding='same',
                                              use_bias=False,
                                              kernel_initializer=kernel_initializer)
        self.bn1_1=batch_norm()
        self.conv1_2 = tf.keras.layers.SeparableConv2D(filters=24,
                                              kernel_size=(3, 3),
                                              strides=2,
                                              padding='same',
                                              use_bias=False,
        ...
        self.conv2_1 = tf.keras.layers.SeparableConv2D(filters=32,
                                              kernel_size=(3, 3),
                                              strides=2,
                                              padding='same',
                                              use_bias=False,
                                              kernel_initializer=kernel_initializer)
        self.bn2_1 = batch_norm()
        self.conv2_2 = tf.keras.layers.SeparableConv2D(filters=64,
                                              kernel_size=(3, 3),
                                              strides=2,
                                              padding='same',
                                              use_bias=False,
...
class InceptionSeparable(tf.keras.Model):

    def __init__(self,
                 kernel_initializer='glorot_normal'):
        super(InceptionSeparable, self).__init__()
        self.conv1 = tf.keras.layers.SeparableConv2D(filters=32,
                                            kernel_size=(1, 1),
                                            strides=1,
                                            padding='same',
                                            use_bias=False,
        ...
        self.avgpool=tf.keras.layers.AveragePooling2D(pool_size=(3,3),
                                                      strides=1,
                                                      padding='same')
        self.conv2 = tf.keras.layers.SeparableConv2D(filters=32,
                                            kernel_size=(1, 1),
                                            strides=1,
                                            padding='same',
                                            use_bias=False,
        ...
        self.conv3_1 = tf.keras.layers.SeparableConv2D(filters=24,
                                              kernel_size=(1, 1),
                                              strides=1,
                                              padding='same',
                                              use_bias=False,
                                              kernel_initializer=kernel_initializer)
        self.bn3_1 = batch_norm()
        self.conv3_2 = tf.keras.layers.SeparableConv2D(filters=32,
                                              kernel_size=(3, 3),
                                              strides=1,
                                              padding='same',
                                              use_bias=False,
        ...
        self.conv4_1 = tf.keras.layers.SeparableConv2D(filters=24,
                                              kernel_size=(1, 1),
                                              strides=1,
                                              padding='same',
                                              use_bias=False,
                                              kernel_initializer=kernel_initializer)
        self.bn4_1 = batch_norm()
        self.conv4_2 = tf.keras.layers.SeparableConv2D(filters=32,
                                              kernel_size=(3, 3),
                                              strides=1,
                                              padding='same',
                                              use_bias=False,
                                              kernel_initializer=kernel_initializer)
        self.bn4_2 = batch_norm()
        self.conv4_3 = tf.keras.layers.SeparableConv2D(filters=32,
                                              kernel_size=(3, 3),
                                              strides=1,
                                              padding='same',
                                              use_bias=False,
...
class DecreaseBlockSeparable(tf.keras.Model):

    def __init__(self,
                 kernel_initializer='glorot_normal'):
        super(DecreaseBlockSeparable, self).__init__()
        self.conv1 = tf.keras.layers.SeparableConv2D(filters=128,
                                            kernel_size=(1, 1),
                                            strides=1,
                                            padding='same',
                                            use_bias=False,
        ...
        self.conv2 = tf.keras.layers.SeparableConv2D(filters=256,
                                            kernel_size=(3, 3),
                                            strides=2,
                                            padding='same',
                                            use_bias=False,
...
class FaceBoxesSeparable(tf.keras.Model):
    def __init__(self,
                 kernel_initializer='glorot_normal'):
        super(FaceBoxesSeparable, self).__init__()

        self.RDCL=RDCLSeparable(kernel_initializer=kernel_initializer)
        self.inception_blocks=[InceptionSeparable(kernel_initializer=kernel_initializer) for i in range(3)]

        self.decrease_blocks=[DecreaseBlockSeparable(kernel_initializer=kernel_initializer) for i in range(2)]
