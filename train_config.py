...
config.TRAIN.lr_value_every_step = [0.001,0.001,0.001,0.0001,0.00001,0.000001]
config.TRAIN.lr_decay_every_step = [1000,2000,20000,30000,40000]
...
#####
config.MODEL.hin = 1024  # input size during training , 512
